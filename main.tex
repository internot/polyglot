...
The target is infiltrated by the attacker, manipulating the website to
...
The \emph{attacker.com} site embeds the polyglot content from \emph{vulnerable.com}, but
...
for said tokens. The samples are benign strings containing \todo{?}. The conclusion is 
