...
To give more context to the scenario, vulnerable.com can be a cloud storage service. 
The attacker infiltrates the target by uploading a polyglot to the service and embed it 
on attacker.com. While authenticated to vulnerable.com, the unsuspecting victim visits attacker.com, the embedded 
