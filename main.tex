...
The OWASP top 10 list~\cite{OWASP:top10:2010} places injection
...
\emph{injection attacks} that 
operate across multiple languages and (ii) \emph{content repurposing} that supply
malicious payload that appears formatted as benign content. 
...
This is not to be confused with Cross-Origin Resource Sharing (CORS)~\cite{w3-cors}, which is an 
