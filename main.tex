...
Once infiltrated, the polyglot is embedded in the attacker's web site using a plug-in.
According to the SOP, content loaded in a plug-in is considered to belong to the 
origin from which the content was requested, thus allowing the polyglot to communicate with the vulnerable 
