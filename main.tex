...
\begin{figure}[t]
  \center
  \includegraphics[width=0.49\textwidth]{scenario.pdf}
...
\begin{figure}[t]
  \center
  \includegraphics[width=0.49\textwidth]{injection-scenario.pdf}
...
\paragraph{Scenario}
The content smuggling scenario proceeds as illustrated in Figure~\ref{fig:scenario}.
